...
var body = { resources: 25.00 };
function trade() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, adxusdtList, glmusdList, clvusdList, sandusdList, oceanusdList, i, priceTimestamp, priceTimestamp, priceTimestamp, priceTimestamp, priceTimestamp;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('http://localhost:3000/price-data')];
                case 1:
                    response = _a.sent();
